    ...
    return (
      <div className="AvatarCropper-canvas">
        ...
        <div className='modal-footer'>
          <button className={this.props.closeButtonClass} onClick={this.props.onRequestHide}>{this.props.closeButtonCopy}</button>
          <button bsStyle='' className={this.props.cropButtonClass || 'btn btn-primary'} onClick={this.handleCrop.bind(this)}>
  ...
  render () {
    return (
      <Modal
        ...
        dialogClassName={this.props.modalClass}
        ...
        <div className="modal-body">
          ...
          <div className="AvatarCropper-base">
            ...
            <Cropper
              ...
              cropButtonClass={this.props.cropButtonClass}
            />
          </div>
...
AvatarCropper.propTypes = {
  ...
  cropButtonClass: React.PropTypes.string,
  width: numberableType,
  height: numberableType,
